<?php
	...
	if($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["commentVar"])) {
		...
		if($error == '') {
			...
			$value = uploadComment('photoComment', $comment_content, $photo_id, $user_id, $currentTime, $con);
                    ...
                    <div class="affix" id="leftSideBar">
                        ...
                        <div class="well">
                            ...
                            <div class="well">
                                ...
                                <p><a href="<?php echo 'profile.php?user_id='.$user_id; ?>">My Profile</a></p>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <div class="col-sm-10 well well-sm">
								...
								<form class="form-inline" name="comment" action="homepage.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="affix" id="rightSideBar">
                        <div class="well">
                            <div class="thumbnail">
                                ...
                                <p>Fri. 27 November 2015<?php echo $currentTime; ?></p>
